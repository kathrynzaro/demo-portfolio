    ...
    <div className='App'>
      <div className='connect-page'>
        ...
        <div className='link-wrapper'>
          <h2>Send me an
            <a href='mailto: zarokathryn@gmail.com' target='_blank' rel="noreferrer"> email</a>.
          </h2>
          <h2>Check out my 
            <a href='/katzaro-resume-5.pdf' target='_blank' rel="noreferrer"> resume</a>.
          </h2>
          <h2>And my 
            <a href='https://www.linkedin.com/in/katzaro/' target='_blank' rel="noreferrer"> LinkedIn</a>.
          </h2>
          <h2>Maybe even my 
            <a href='https://github.com/kathrynzaro' target='_blank' rel="noreferrer"> GitHub</a>?
          </h2>
